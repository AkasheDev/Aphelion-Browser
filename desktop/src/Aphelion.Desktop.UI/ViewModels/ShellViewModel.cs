...
public sealed partial class ShellViewModel : ViewModelBase
{
    ...
    public ShellViewModel(Func<BrowserViewModel> browserFactory, SidePanelViewModel sidePanel)
    {
        _browserFactory = browserFactory ?? throw new ArgumentNullException(nameof(browserFactory));
        SidePanel = sidePanel ?? throw new ArgumentNullException(nameof(sidePanel));
